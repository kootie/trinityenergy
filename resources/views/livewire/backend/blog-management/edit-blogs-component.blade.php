                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                           ...
                           <img src="{{ $new_cover_image->temporaryURL() }}" class="img-thumbnail" alt="..." height="100" width="100">
                            @else
                            <label for="">Cover image preview</label>
                           <img src="{{ asset('front-assets/img/blog') }}/{{ $blog->cover_image }}" class="img-thumbnail" alt="..." height="100" width="100">
                           @endif
                        </div>
                    
                        <div wire:ignore>
                            <label for="summernote" class="form-label">Enter description</label>
                            <textarea class="form-control" id="summernote" rows="3">{{ $body }}</textarea>
                        </div>
                    </div>
                    <div class="card-footer">
                        <button class="btn btn-success" wire:click.prevent='updateBlog'>Update blog</button>
                    </div>
                </div>
            </div>
