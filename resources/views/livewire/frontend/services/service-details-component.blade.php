<div>
 ...
 ============================================= -->
    <section id="breadcrumb" class="breadcrumb-section position-relative" data-background="{{ asset('front-assets/img/service/Services.png') }}">
                            ...
                            <div class="service-cat-widget ul-li-block">
                                ...
                                <ul>
                                    @foreach ($services as $s)
                                        <li><a href="{{ route('service.details', ['slug'=>$s->id]) }}">{{ $s->title }}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div>
