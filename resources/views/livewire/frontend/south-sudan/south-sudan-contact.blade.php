        ...
        <div class="earth3dmap-com">
            <div style="width: 100%">
                <div style="width: 100%"><iframe width="100%" height="500" frameborder="0" scrolling="no"
                        ...
                        src="https://maps.google.com/maps?width=100%25&amp;height=500&amp;hl=en&amp;q=Trinity%20Energy%20House%20Airport-Ministries%20Road,Hai%20Matar%20Juba,Republic%20of%20South%20Sudan+(My%20Business%20Name)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"><a
                            href="https://www.maps.ie/population/">Population Estimator map</a></iframe></div>
                            ...
                            <div class="el-contact-info">
                                <div class="contact-address">
                                    ...
                                    <div class="contact-text pera-content headline">
                                        ...
                                        <p>2nd Floor Trinity Energy House Airport-Ministries Road,Hai Matar
                                            P.O Box 362,Juba,Republic of South Sudan</p>
                                    </div>
                                </div>
                                <div class="contact-address">
                                    <div class="contact-icon">
                                ...
                                <div class="contact-address">
                                    ...
                                    <div class="contact-text pera-content headline">
                                        <h4>Contact us</h4>
                                        <p><STRONG> +211 915633230<br></STRONG>
                                            info@trinityenergyltd.com</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="contact-form-area contact-form">
                                <form method="post" id="contact-form" wire:submit.prevent='sendMessage'>
                                    ...
                                    @error('comments')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                    <textarea id="message" name="message" placeholder="Comments*" wire:model='comments'></textarea>

                                    <div class="sub-button  text-uppercase">
                                        <button type="submit" value="Submit">Send Message <img
                                                src="assets/img/arrow3.png" alt=""></button>
                                    </div>
                                </form>
                            </div>
                        </div>
