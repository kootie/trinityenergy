...
<!-- Start of breadcrumb section
	...
	<section id="breadcrumb" class="breadcrumb-section position-relative"
        data-background="front-assets/img/investors/Investors.png">
        <div class="background_overlay"></div>
        <div class="container">
            <div class="breadcrumb-content headline">
                <h2 class="breadcrumb-title">Investor Relations</h2>
                <div class="breadcrumb_item ul-li">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('homepage') }}">Home</a></li>
                        <li class="breadcrumb-item active">Investor Relations</li>
                    </ul>
                </div>
            </div>
        </div>
					...
					<div class="service-sidebar">
						<div class="service-sidebar-widget">
							<div class="service-cat-widget ul-li-block">
								...
								<ul>
									<li><a href="#">Afrexim Bank</a></li>
									<li><a href="#">Kenya Commercial Bank</a></li>
									<li><a href="#">Equity Bank</a></li>
									<li><a href="#">Stanbic Bank</a></li>							
								</ul>
							</div>
						</div>
						
						<div class="service-sidebar-widget">
							<div class="opening-hour-widget" data-background="front-assets/img/investors/profile-cover-2.jpg">
							<a href="front-assets/files/Trinity-Company-Profile.pdf" style="font-weight:bold; font-size:24px; color:#000000" target="_blank">View Our <br> Company Profile</a>
						...
						<div class="add-widget text-center pera-content position-relative" data-background="assets/img/background/bcbg.jpg">
							...
							<a href="{{ route('contact.us') }}">Get in Touch <img src="assets/img/arrow3.png" alt=""></a>
						</div>
					</div>
				</div>
				<div class="col-lg-8 col-md-12">
					<div class="service-single-content">
					<h4>Trinity Energy’s Strong Partnership with Financial Partners</h4>
						<div class="service-details-img-pair">
							<div class="row">
								<div class="col-md-6">
									<img src="front-assets/img/investors/afrexim2.png" style="height=300px !important" alt="">
								</div>
								<div class="col-md-6">
									<img src="front-assets/img/investors/afrexim3.jpeg" alt="">
								</div>
							</div>
						</div>
						<article>
						For the last ten years, Trinity Energy has enjoyed a robust partnership with financing partners consisting of both regional and Pan-African banks. Leading this partnership has been Afreximbank with whom the company has enjoyed a robust partnership that has seen the Bank extend a revolving refined products Import Financing Facility that has been instrumental in stabilising fuel supply into South Sudan and overall guaranteeing energy security for the country. This renewed commitment is a testament to the success of their prior collaboration, where Afreximbank provided crucial support. 
						</article>						
						<div class="row">
							<div class="col-md-6">
								<div class="service-details-list ul-li-block">
									<article class="text-justify">
										Afreximbank's confidence in Trinity Energy's transformative agenda and growth prospects is vividly demonstrated by the decision taken by the Bank to enhance the refined products Import Financing Facility from the earlier limit of USD 30 million to a robust USD 50 million.
									</article>								
								</div>
							</div>
							<div class="col-md-6">
								<img src="front-assets/img/investors/afrexim.jpeg" alt="">
							</div>
						</div>
						<div class="service-single-icon-text">
							<div class="site-info-icon-text position-relative">
								<div class="site-info-icon float-right">
								<svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512"><path d="M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z"/></svg></div>
									...
									<a href="front-assets/files/Trinity-Energy-Afreximbank-and-Commercial-Banks-Support.pdf" style="font-weight:bold; color:#ffcc00" target="_blank">FIND OUT MORE</a>
