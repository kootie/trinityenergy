<div>
 ...
 ============================================= -->
    <section id="slider-eltron" class="slider-section slider-style-one" wire:ignore>
        <div id="slider-main" class="slider-content owl-carousel">
            <div class="main-slider-img-text slide-type-two pera-content headline position-relative">
                <div class="slider-img-bg img-zooming" 
                    data-background="{{ asset('front-assets/img/slider/Home.png') }}">
                </div>
                <div class="background_overlay"></div>
                <div class="container">
                    <div class="slider-content-box">
                        <span class="title-tag text-uppercase"><img src="assets/icon/icon5.svg" alt="">producing
                            what matters!</span>
                        <h1>DRIVING AFRICA FORWARD</h1>
            ...
            <div class="main-slider-img-text slide-type-two pera-content headline position-relative">
                ...
                <div class="container">
                    <div class="slider-content-box text-center">
                        <span class="title-tag text-uppercase"><img src="assets/icon/icon5.svg" alt=""></span>
                        <h1>OUR VISION</h1>
                        <p>To be a leader and catalyst in the provision of sustainable energy
                            solutions</p>
                    </div>
                </div>
            </div>
            <div class="main-slider-img-text slide-type-two pera-content headline position-relative">
                ...
                <div class="container">
                    <div class="slider-content-box text-center">
                        <span class="title-tag text-uppercase"><img src="assets/icon/icon5.svg" alt=""></span>
                        <h1>OUR MISSION</h1>
                        <p>We provide innovative energy solutions through state-of-the-art
                            technologies to positively impact lives in our markets</p>
                    </div>
                </div>
            </div>
            <div class="main-slider-img-text slide-type-two pera-content headline position-relative">
                ...
                <div class="container">
                    <div class="slider-content-box text-center">
                        <span class="title-tag text-uppercase"><img src="assets/icon/icon5.svg" alt=""></span>
                        <h1>CORE VALUES</h1>
                        <p>• Ethical • Excellence • Professionalism • Integrity •
                            Customer Centric</p>
                    </div>
                </div>
            </div>
...
<!-- Start of Features section
	============================================= -->
	<section id="features" class="features-section position-relative" data-background="">
		<div class="background_overlay"></div>
		<div class="container">
			<div class="section-title-middle text-center">
			
				<h2>Trinity Energy's Operations</h2>
			</div>
			<!-- /title -->
			<div class="features-content">
				<div class="row">

                    <!-- Aug 14, 2023 [Error]: Operations  is not bein loaded on the first attempt. A solution needs to be found for this. -->
                    ...
                    <div class="col-lg-4 col-md-6">
						<div class="features-icon-text text-center position-relative">
                            ...
                            <img src="{{ asset('front-assets/img/home-page/Upstream-Ops.png') }}" alt="">
							</div>
                            @elseif ($key == 1)
                            <div class="features-icon">
                            <img src="{{ asset('front-assets/img/home-page/Downstream-Ops.png') }}" alt=""></div>
                            @else
                            <div class="features-icon">
                            <img src="{{ asset('front-assets/img/home-page/Powerplant-Ops.png') }}" alt=""></div>
                            @endif
							<div class="features-text headline pera-content">
								<h3>{{ $operation->title }}</h3>
								@if ($key == 0)
                                <p class="text-center">Various Oilfield Services</p>
                                @elseif ( $key == 1)
                                <p class="text-center">Fuel Delivery Services</p>
                                @else
                                <p class="text-center"s>Power Plant Development</p>
							...
							<div class="features-hover-content">
								...
								<div class="features-hover-text headline pera-content">
									<h3>{{ $operation->title }}</h3>
									<p>{{ Illuminate\Support\Str::limit(strip_tags($operation->description), $limit =
                                        150, $end = '...') }}</p>
									<div class="fh-more">
										<a href="{{ route('operation.details', ['slug' => $operation->id]) }}"><i class="icon-arrow-down"></i></a>
									</div>
								</div>
							</div>
						</div>
...
<!-- End of Features section
	...
	============================================= -->
    <section id="advantage" class="advantage-section" style="padding-top: 50px !important;">
        <div class="container">
            <div class="section-title-middle text-center">
                <span class="title-tag"><svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <path class="cls-1"
                            ...
                            transform="translate(-103.26 -141.54)" />
                        <path class="cls-1"
                ...
                <div class="row">
                  ...
                  <a href="#">
                        ...
                        <div class="advantage-img-text">
                            <div class="advantage-img">
                                <img src="{{ asset('front-assets/img/service/1.jpg') }}"
                                    alt="">
                            </div>
                  ...
                  <div class="col-lg-3 col-md-6">
                    <a href="#">
                            ...
                            <div class="advantage-img-text">
                                <div class="advantage-img">
                                    <img src="{{ asset('front-assets/img/sustainability/Sustainability.png') }}" alt="" style="height: 196px;
                                    object-fit: cover;
                                    width: 100%;">
                                </div>
                                <div class="advantage-text text-center text-uppercase headline">
                  ...
                  <a href="#">
                            ...
                            <div class="advantage-img">
                                <img src="{{ asset('front-assets/img/service/covid 19 donations 2.jpg') }}"
                                    alt="">
                            </div>
                            <div class="advantage-img-text">
                            <div class="advantage-text text-center text-uppercase headline">
                                <h3>Health <br> Initiatives</h3>
                            </div>
                        </div>
                  ...
                  <div class="col-lg-3 col-md-6">
                    <a href="#">
                            ...
                            <div class="advantage-img-text">
                                <div class="advantage-img">
                                    <img src="{{ asset('front-assets/img/service/construction of school and postofficw.jpg') }}"
                                        alt="">
                                </div>
                                <div class="advantage-text text-center text-uppercase headline">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12">
                        <div class="expertise-text">
                            ...
                            <div class="expertise-text-details text-justify"">
                                Our dedicated team of professionals is driven by a passion for innovation. We
                                continuously seek new opportunities to expand our offerings, improve our services, and
                                contribute to the sustainable development of the continent. By embracing cutting-edge
                                technologies and industry best practices, we aim to lead positive change in the energy
                                sector
                            </div>
                            <!-- <div class="expertise-skill-progress">
                                <div class="single_experties">
                                    <div class="progress_text">
                                        <div class="skill-title float-left text-capitalize">1. Upstream operations</div>
                                        <div class="skill-percent float-right">75%</div>
                                    </div>
                                    <div class="progress">
                                        <div class="progress-bar wow Rx-width-75 animated" role="progressbar"
                                ...
                                <div class="single_experties">
                                    <div class="progress_text">
                                        <div class="skill-title float-left text-capitalize">2. Downstream Operations
                                        </div>
                                        <div class="skill-percent float-right">80%</div>
                                    </div>
                                    <div class="progress">
                                        <div class="progress-bar wow Rx-width-80 animated" role="progressbar"
                                            data-wow-duration="1.5s" data-wow-delay=".5s" aria-valuenow="0"
                                            aria-valuemin="0" aria-valuemax="100">
                                        </div>
                                    </div>
                                ...
                                <div class="single_experties">
                                    <div class="progress_text">
                                        <div class="skill-title float-left text-capitalize">3. Power Plant Projects
                                        </div>
                                        <div class="skill-percent float-right">90%</div>
                                    </div>
                                    <div class="progress">
                                        <div class="progress-bar wow Rx-width-90 animated" role="progressbar"
                                            data-wow-duration="1.5s" data-wow-delay=".5s" aria-valuenow="0"
                                            aria-valuemin="0" aria-valuemax="100">
                                        </div>
                                    </div>
            ...
            <div id="expertise_carouselid" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="{{ asset('front-assets/img/home-page/Innovation.png') }}"
                            alt="">
                    </div>
    ...
    <!-- <div class="mission-area">
        <div class="mission-text">
            <div class="section-title-left">
                <span class="title-tag"><img src="assets/icon/icon5.svg" alt=""><h5>Our Core Values</h5></span>
                
                {{-- <div class="mt-3">
                    <h5>Core Values</h5>

                    <div class="d-flex flex-row justify-between gap-3">
                        <span
                            class="ps-2 pe-2 badge border border-info text-black rounded-pill">Excellence</span>
                        <span
                            class="ps-2 pe-2 badge border border-info text-black rounded-pill">Customer
                            Centric</span>
                        <span
                            class="ps-2 pe-2 badge border border-info text-black rounded-pill">Ethical</span>
                        <span
                            class="ps-2 pe-2 badge border border-info text-black rounded-pill">Integrity</span>
                        <span
                            class="ps-2 pe-2 badge border border-info text-black rounded-pill">Professionalis</span>
                    </div>

                </div> --}}
                <h2>Excellence, Customer Centric, Ethical, Integrity & Professionalis</h2>
            </div>
        </div>
    </div> -->
 ...
 ============================================= -->
 <section id="service-counter" class="service-counter-section" style="padding-bottom: 50px !important; margin-top: 70px !important">
    <div class="container">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="about-counter-text-number headline">                        
                        <div class="counter-icon float-left">
                            <img src="front-assets/icon/icon12.svg"
                                alt="">
                        </div>
                        <div class="counter-number">
                            <h4 class="counter">1.5</h4><strong>M+</strong>
                        </div>
                        <h4 class="text-center">Invested in CSR</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="about-counter-text-number headline">                        
                        <div class="counter-icon float-left">
                            <img src="front-assets/icon/icon13.svg"
                                alt="">
                        </div>
                        <div class="counter-number">
                            <h4 class="counter">400</h4><strong>+</strong>
                        </div>
                        <h4 class="text-center">Members of Staff</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="about-counter-text-number headline">                        
                        ...
                        <div class="counter-number">
                            <h4 class="counter">15</h4><strong>M+</strong>
                        </div>
                        <h4 class="text-center">Paid in Taxes</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="about-counter-text-number headline">                        
                        ...
                        <div class="counter-number">
                            <h4 class="counter">350</h4><strong>M+</strong>
                        </div>
                        <h4 class="text-center">Fuel Products Traded</h4>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="blog-post-item">
                            ...
                            <div class="blog-post-text">
                                ...
                                <div class="blog-more text-uppercase">
                                    <a href="{{ route('single.blog', ['slug'=>$blog->id]) }}">full story <i
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <div class="form-group custom-control custom-checkbox custom-control-inline">
                                    <input type="checkbox" id="fuelsupply" name="fuelsupply"
                                        class="custom-control-input" value="fuelsupply" wire:model='service.fuelsupply'>
                                    <label class="custom-control-label" for="fuelsupply">Fuel supply</label>
                                </div>
                                <div class="form-group custom-control custom-checkbox custom-control-inline">
                                    <input type="checkbox" id="powergenerarion" name="powergenerarion"
                                        class="custom-control-input" value="powergenerarion"
                                        wire:model='service.powergenerarion'>
                                    <label class="custom-control-label" for="powergenerarion">Power
                                        generation</label>
                                </div>
                                <div class="form-group custom-control custom-checkbox custom-control-inline">
                                    <input type="checkbox" id="solarpower" name="solarpower"
                                        class="custom-control-input" value="solarpower" wire:model='service.solarpower'>
                                    <label class="custom-control-label" for="solarpower">Solar power</label>
                                </div>
                                @error('service')
                                <p class="text-danger">{{ $message }}</p>
                                @enderror
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" wire:click.prevent='submitRequest'>Submit
                        request</button>
                </div>
            </div>
        </div>
