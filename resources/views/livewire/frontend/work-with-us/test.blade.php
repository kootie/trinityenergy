                ...
                <div class="testimonial-part testimonial-text-slide">
                    <div id="testimonial-slideid" class="testimonial-slide owl-carousel">
                        <div class="testimonial-slide-text headline pera-content position-relative">
                            ...
                            <h3>“My Trinity My Energy”</h3>
                            <p>Charles Taban a taxi driver in Juba, South Sudan, he has been in the transport industry for many
                        ...
                        <div class="testimonial-slide-text headline pera-content position-relative">
                            ...
                            <h3>“I recommend Trinity Energy”</h3>
                            <p>Leone Deneki Peter, a volunteer with Right for All Organization (RFAO), is a devoted customer who
                                ...
                                sought after in South Sudan. I personally rely on their fuel for both my car and motorcycle, and I&#39;ve
                                found the quality to be more than satisfactory. It&#39;s worth noting that Trinity Energy also serves
                                aviation companies.&quot;
                            </p>
                            <div class="testimonial-img-rate">
                                
                                <div class="testimonial-rate ul-li">
                                    <h4>Leone Deneki Peter</h4>
                                    <span>RFAO</span>
                                    <ul>
                                        <li><i class="fas fa-star"></i></li>
                                        <li><i class="fas fa-star"></i></li>
