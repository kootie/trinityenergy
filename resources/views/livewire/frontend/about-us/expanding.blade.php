    ...
    <section id="breadcrumb" class="breadcrumb-section position-relative"
        ...
        <div class="container">
            <div class="breadcrumb-content headline">
                <h2 class="breadcrumb-title">Expanding Our Energy Services</h2>
                <div class="breadcrumb_item ul-li">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('homepage') }}">Home</a></li>
                        <li class="breadcrumb-item active">Expanding Our Energy Services</li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="about-text">
                            <div class="section-title-left">
                                <span class="title-tag"><img src="assets/icon/icon5.svg" alt="">Who We
                                    Are</span>
                                <h2>Expanding Our Energy Services</h2>
                            </div>
                            <!-- title -->
                            <div class="about-content pera-content">
                                <div class="about-text1 text-justify">
                                    <p>
                                    At Trinity Energy, we continuously evolve to meet the changing needs of our customers and align with the global shift towards sustainable energy sources. While we have a strong foundation in fuel supply, we now proudly offer expanded services that focus on upstream operations and renewable energy solutions.
                                    </p>
                                </div>
