    ...
    <section id="breadcrumb" class="breadcrumb-section position-relative"
        ...
        <div class="container">
            <div class="breadcrumb-content headline">
                <h2 class="breadcrumb-title">Energy Solutions</h2>
                <div class="breadcrumb_item ul-li">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('homepage') }}">Home</a></li>
                        <li class="breadcrumb-item active">Energy Solutions</li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="about-text">
                            <div class="section-title-left">
                                <span class="title-tag"><img src="assets/icon/icon5.svg" alt="">Who We
                                    Are</span>
                                <h2>Energy Solutions for Sustainable Future</h2>
                            </div>
                            <!-- title -->
                            <div class="about-content pera-content">
                                <div class="about-text1 text-justify">
                                    <p>
                                    At Trinity Energy, we are dedicated to providing comprehensive energy solutions and services that meet the evolving needs of our clients while promoting a sustainable future. We specialize in upstream and downstream services, as well as renewable energy, to support a diverse range of industries and contribute to the global transition towards clean energy.
                                    </p>
                                </div>
