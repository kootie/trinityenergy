...
namespace App\Http\Livewire\Frontend\SouthSudan;

use App\Models\Inquiry;
use Livewire\Component;

class SouthSudanContact extends Component
{
    public $name;
    public $email;
    public $subject;
    ...
    {
        return view('livewire.frontend.south-sudan.south-sudan-contact')->layout('layouts.frontend');
    }
}
