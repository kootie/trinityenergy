...
namespace App\Http\Livewire\Frontend\Kenya;

use App\Models\Inquiry;
use Livewire\Component;

class KenyanContact extends Component
{
    public $name;
    public $email;
    public $subject;
    ...
    {
        return view('livewire.frontend.kenya.kenyan-contact')->layout('layouts.frontend');
    }
}
